...
export class receiptService {
    ...
    async getReceiptDetailsView(receiptModel :POReceiptFilter) {
        const data= await this.http.post<ReceiptModel>(`${environment.apiUrl}/Receipt/GetReceiptPODetailsView`,
    ...
    addReceipt(receiptMasterModel: ReceiptModel) {
